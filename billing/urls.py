...
urlpatterns = [
    ...
    path('products/<int:pk>/price/', views.product_price, name='product_price'),
    path('billing/products-by-supplier/', views.products_by_supplier, name='products_by_supplier'),
